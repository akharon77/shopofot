...
void UniversalLayoutBox::onParentUpdate(const plug::Vec2d &parent_size)
{
...
void UniversalLayoutBox::onParentUpdate(const plug::LayoutBox &parent_box)
{
    onParentUpdate(parent_box.getSize());
}

bool UniversalLayoutBox::setSize(const plug::Vec2d &size)
{
    if (!m_resizable)
        return false;
...
bool UniversalLayoutBox::setPosition(const plug::Vec2d &position)
{
    if (m_align != Align::Free)
        return false;
...
plug::Vec2d UniversalLayoutBox::getSize() const
{
...
plug::Vec2d UniversalLayoutBox::getPosition() const
{
