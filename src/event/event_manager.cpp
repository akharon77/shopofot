...
void EventManager::sendEvents(Widget *widget)
{
...
MouseMoveEvent EventManager::convertMove(const sf::Event &sf_event) const
{
...
MousePressedEvent EventManager::convertMousePressed(const sf::Event &sf_event) const
{
...
MouseReleasedEvent EventManager::convertMouseReleased(const sf::Event &sf_event) const
{
...
KeyboardPressedEvent EventManager::convertKeyPressed(const sf::Event &sf_event) const
{
...
KeyboardReleasedEvent EventManager::convertKeyReleased(const sf::Event &sf_event) const
{
...
TickEvent EventManager::makeTickEvent(void)
{
